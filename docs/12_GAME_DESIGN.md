...
- Player Blacksmith：依已購圖紙、素材與 gold 加工費鍛造 equipment／Sword Soul、升級 blacksmith
  ...
  並將素材或成品依品質放到單格販售桌，從快速成交（80%）、公道定價（100%）或
  精品標價（135%）擇一。流言菲語會公開特定商品／最低品質需求；符合時具名顧客
  必定來訪，再套用 170%–220% 的高價倍率，結帳後顯示 `+GOLD`。精品商品若未符合
  流言，普通顧客只有 45% 機率接受；拒絕時商品仍留在販售桌，但同一次報價不能重試，
  玩家必須撤下商品並重新選擇價格。
