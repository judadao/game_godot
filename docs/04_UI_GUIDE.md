...
- Player Blacksmith：進場先顯示幾何熔爐、工作台與商店門，不能把服務功能直接列成選單；
  ...
  顧客與入口；初始只顯示店內可互動物件，不能直接列出庫存／貨架／流言功能。點商品展示位
  ...
  店內視覺使用石木背景、貨架／鍛造櫃台中景、近景木檯與側柱遮擋，以及可替換的
  鈴鐺、工具架、布旗、鐵錠箱、藥瓶燭台、盾劍展示裝潢。三層圖片皆為
  `MOUSE_FILTER_IGNORE`；透明 hotspot 不得顯示矩形焦點框或被前景阻擋。背景、前中景與裝潢
...
潮槍／雙刀／王冠／雷槍／戰馬／聖槍／死神具體主體為第一閱讀層，再投影兩個來源的幾何 motif
