...
| Survival pressure | 8:30、開場 30 隻；alive cap 48→170、batch 10→20、interval 0.35→0.08 秒；每分鐘強敵、180／360 秒 Boss、最後 30 秒紅色複數狂潮；普通怪死亡後 0.05 秒內排入補怪；生成／回收使用玩家前後 680–820px perimeter，1200px 外回收且每 0.35 秒檢查 |
