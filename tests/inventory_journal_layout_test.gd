...
func _check_size(viewport_size: Vector2i) -> void:
	...
	ui.call("set_equipment_entries", [
		{"slot": "weapon", "id": "iron_sword", "name": "Iron Sword", "level": 3, "stats": "Attack +4", "icon_path": "res://assets/ui/equipment/generated/iron_sword.png"},
		{"slot": "armor", "id": "leather_armor", "name": "Leather Armor", "level": 3, "stats": "Defense +2 · Max Health +10", "icon_path": "res://assets/ui/equipment/generated/leather_armor.png"},
		{"slot": "accessory", "id": "swift_ring", "name": "Swift Ring", "level": 3, "stats": "Move Speed +8%", "icon_path": "res://assets/ui/equipment/generated/swift_ring.png"},
	])
	ui.call("set_sword_souls", [
		{"instance_id": "journal-layout-flame", "name": "流火附魔", "level": 3, "kind_label": "現有劍魂", "bonus_type_label": "元素", "description": "讓武器斬擊纏上火焰。", "ability_summary": "攻擊傷害 +4、附魔 1.5 秒", "icon_path": "res://assets/ui/autumn/cards/generated/flame_imbue.png"},
		{"instance_id": "journal-layout-guard", "name": "守勢", "level": 2, "kind_label": "現有劍魂", "bonus_type_label": "防禦", "description": "以沉穩架勢抵住迎面衝擊。", "ability_summary": "霸體階級 1、持續 1.5 秒", "icon_path": "res://assets/ui/autumn/cards/generated/guard.png"},
		{"instance_id": "journal-layout-heal", "name": "治癒之光", "level": 3, "kind_label": "現有劍魂", "bonus_type_label": "治療", "description": "柔光會尋向傷勢最重的同伴。", "ability_summary": "恢復 20 生命並連鎖治療", "icon_path": "res://assets/ui/autumn/cards/generated/healing_light.png"},
		{"instance_id": "journal-layout-step", "name": "疾行步法", "level": 1, "kind_label": "現有劍魂", "bonus_type_label": "機動", "description": "借風勢縮短與敵人的距離。", "ability_summary": "移動速度 +10%", "icon_path": "res://assets/ui/autumn/cards/generated/fleet_footwork.png"},
		{"instance_id": "journal-layout-breath", "name": "奧術吐納", "level": 2, "kind_label": "現有劍魂", "bonus_type_label": "AP", "description": "以規律吐納加速行動力恢復。", "ability_summary": "AP 回復 +0.40", "icon_path": "res://assets/ui/autumn/cards/generated/arcane_breath.png"},
		{"instance_id": "journal-layout-rhythm", "name": "戰鬥節奏", "level": 3, "kind_label": "現有劍魂", "bonus_type_label": "攻擊", "description": "連續斬擊會讓攻勢更加銳利。", "ability_summary": "攻擊傷害 +4", "icon_path": "res://assets/ui/autumn/cards/generated/battle_rhythm.png"},
		{"instance_id": "journal-layout-frost", "name": "霜爆附魔", "level": 2, "kind_label": "現有劍魂", "bonus_type_label": "元素", "description": "冰霜附著斬擊並拖慢敵人。", "ability_summary": "緩速 30%、附魔 1.5 秒", "icon_path": "res://assets/ui/autumn/cards/generated/frostburst_imbue.png"},
		{"instance_id": "journal-layout-iron", "name": "鐵骨", "level": 1, "kind_label": "現有劍魂", "bonus_type_label": "防禦", "description": "凝練筋骨以承受更多傷害。", "ability_summary": "防禦 +2", "icon_path": "res://assets/ui/autumn/cards/generated/iron_bone.png"},
	])
	ui.call("set_codex_entries", [
		{"section": "techniques", "id": "ember_bolt", "name": "Ember Bolt", "category": "attacks", "kind_label": "DISCOVERED BASIC ATTACK", "preview_kind": "basic_attack", "element": "normal", "level": 3, "combo_stack": 7, "evolution_layers": ["ember spark", "burning edge", "scarlet arc"], "stack_milestones": [3, 6, 9], "stack_traits": ["warm edge", "double ember", "lasting blaze"], "description": "A fast horizontal sword wave recorded after repeated field use. The journal preserves its combat role, current evolution and all activation notes without hiding long text beneath the painted page curl.", "effect_summary": "Deals 28 base damage in a forward arc; current equipment and active Combo modifiers are projected by Game before use.", "trigger_summary": "Automatic basic attack while a valid target is inside the horizontal engagement range.", "icon_path": "res://assets/ui/autumn/cards/generated/ember_bolt.png"},
	])
	ui.call("open")
	await process_frame
