...
const UI_CONTRACTS := [
	...
	},
	{
		...
		"signals": ["opened", "closed", "toggled", "canceled", "building_upgraded"],
		"nodes": [
			"TitleText",
			"BuildingProjectGrid",
			"TownHallProjectButton",
			"BlacksmithProjectButton",
			"WorkshopProjectButton",
			"MarketProjectButton",
			"MemoryLibraryProjectButton",
			"UpgradeButton",
			"CloseButton",
		],
	},
	{
		"name": "PlayerMarketUI",
		"path": "res://scenes/ui/town/PlayerMarketUI.tscn",
		"class_name": "PlayerMarketUI",
		"window": "PlayerMarketWindow",
		"methods": [
			"open",
			"close",
			"set_services",
